#!/usr/bin/env python3
# ============================================
# architecture_b.py - PEFT Metric Learning with Triplet Loss
# Usage: python architecture_b.py --config 5percent --split 1 --epochs 10 --batch_size 64 --auto_resume
# ============================================
...
def train():
    ...
    print("\n" + "="*60)
    print("🎯 ARCHITECTURE B: PEFT Metric Learning")
    print("="*60)
    ...
    checkpoint = CheckpointManager("architecture_b", args.split)
